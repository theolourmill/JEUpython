Le but de ce petit jeu en python est de pouvoir
avoir une fênetre simple, ou le joueur
pourra cliquer sur un bouton pour créer une
ressource puis acheter des améliorations
